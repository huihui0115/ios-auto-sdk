Pod::Spec.new do |s|
  ...
  s.frameworks       = 'Foundation', 'UIKit', 'QuartzCore', 'JavaScriptCore', 'Network', 'NetworkExtension', 'Vision', 'AVFoundation', 'AudioToolbox', 'Photos', 'ImageIO', 'UserNotifications', 'CoreLocation'
